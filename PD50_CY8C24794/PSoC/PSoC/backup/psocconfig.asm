...
;
;    Load configuration registers for t.
...
_LoadConfig_t:
 LoadConfig_t:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_t_Bank0
    mov     X, <LoadConfigTBL_t_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_t_Bank1
    mov     X, <LoadConfigTBL_t_Bank1
