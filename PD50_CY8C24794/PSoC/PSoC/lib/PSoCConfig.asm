...
export LoadConfig_psoc
export _LoadConfig_psoc
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_psoc_Ordered
	lcall	LoadConfig_psoc
...
;---------------------------------------------------------------------------
; Load Configuration psoc
;
;    Load configuration registers for psoc.
...
_LoadConfig_psoc:
 LoadConfig_psoc:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_psoc_Bank0
    mov     X, <LoadConfigTBL_psoc_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_psoc_Bank1
    mov     X, <LoadConfigTBL_psoc_Bank1
