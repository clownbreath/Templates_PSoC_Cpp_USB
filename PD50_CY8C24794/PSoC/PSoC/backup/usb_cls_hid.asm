...
; USB_Protocol is the variable controling boot/report mode for 
; HID devices.
EXPORT  _USB_IdleReload    ; Idle Timer Reload Value
EXPORT   USB_IdleReload    ; Idle Timer Reload Value
EXPORT  _USB_Protocol	  ; Active Protocol
...
;----------------------------------------------------------------------------
  USB_IdleReload:
 _USB_IdleReload:                       BLK   1h    ; Idle Timer Reload Value
 USB_IdleTimer:                         BLK   1h    ; Idle Timers
  USB_Protocol:   
 _USB_Protocol:                         BLK   1h    ; Active Protocol
