...
export LoadConfigTBL_psoc_Bank1
export LoadConfigTBL_psoc_Bank0
export LoadConfigTBL_psoc_Ordered
AREA lit(rom, rel)
LoadConfigTBL_psoc_Ordered:
...
;  Instance name USB, User Module USBFS
	db		ffh
LoadConfigTBL_psoc_Bank1:
;  Global Register values
